...
## Konfigurasi zone untuk domain baru wise.ITB10.com
	echo '
zone "wise.ITB10.com"{
        type master;
 	notify yes;
...
## konfigurasi db lokal untuk wise.ITB10.com
	echo "\
\$TTL    604800
...
" > /etc/bind/wise/3.219.192.in-addr.arpa
...
" > /etc/bind/operation/operation.wise.ITB10.com
...
" > /etc/apache2/sites-available/wise.ITB10.com.conf
...
# vim: syntax=apache ts=4 sw=4 sts=4 sr noet
" > /etc/apache2/sites-available/eden.wise.ITB10.com.conf

mkdir /var/www/eden.wise.ITB10.com
...
' > /var/www/eden.wise.ITB10.com/.htaccess

a2ensite eden.wise.ITB10.com
...
# vim: syntax=apache ts=4 sw=4 sts=4 sr noet
" > /etc/apache2/sites-available/strix.operation.wise.ITB10.com.conf

mkdir /var/www/strix.operation.wise.ITB10.com
...
mv strix.operation.wise/* /var/www/strix.operation.wise.ITB10.com
rm -r strix.operation.wise

a2ensite strix.operation.wise.ITB10.com
